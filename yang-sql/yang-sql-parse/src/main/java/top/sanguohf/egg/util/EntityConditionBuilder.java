...
public class EntityConditionBuilder {
    ...
    /**
     * @param condition 自定义的and查询条件
     * */
    public EntityConditionBuilder appendCondition(String condition){
        JSONObject object = new JSONObject();
        object.put("left","____");
        object.put("right",null);
        object.put("relation",condition);
        doms.add(object);
        return this;
    }
    ...
    public EntityConditionBuilder notEq(String column,Object value){
        JSONObject object = new JSONObject();
        object.put("left",column);
        object.put("right",value);
        object.put("relation","!=");
     ...
     * 转换java为Map查询条件
     * */
    public static <T> JSONObject buildClass(T data) {
        ...
        try {
            ...
            throw new RuntimeException("转换java为Map查询条件错误", e);
        }
