...
import top.sanguohf.egg.test.entity.*;
...
public class TestOne {
    ...
    public void test4() throws NoSuchFieldException, IOException, ClassNotFoundException, InvocationTargetException, IllegalAccessException {
        ...
        params.setTableClassName("Teacher");
        //设置查询条件
        JSONObject con1 = new JSONObject();
        con1.put("left","teacherName");
...
//        commonService.deleteEntity(one);
    ...
    public void test7() throws Exception {
        ...
        commonService.batchDeleteByPrimaryKey(linkedList);
    }
    @Test
    ...
    public void test10() throws Exception {
        ...
        commonService.findEntityList(Teacher.class,Teacher.class);
    }
